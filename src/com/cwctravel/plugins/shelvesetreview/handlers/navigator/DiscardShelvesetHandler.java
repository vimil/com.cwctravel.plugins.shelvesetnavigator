...
public class DiscardShelvesetHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (selection instanceof TreeSelection) {
			...
			if (treeSelection.size() >= 1) {
				...
				new ShelvesetItemUpdateJob(shelvesetItems, ShelvesetItemUpdateJob.UPDATE_TYPE_MARK_SHELVESET_INACTIVE)
						.schedule();
			}
		}
