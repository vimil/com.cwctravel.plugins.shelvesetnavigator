package com.cwctravel.plugins.shelvesetnavigator.constants;
...
public class ShelvesetPropertyConstants {
	...
	public static final String[] SHELVESET_PROPERTIES = { SHELVESET_PROPERTY_REVIEWER_IDS,
			SHELVESET_PROPERTY_APPROVER_IDS, SHELVESET_PROPERTY_CHANGESET_ID, SHELVESET_PROPERTY_BUILD_ID,
			SHELVESET_INACTIVE_FLAG };
}
